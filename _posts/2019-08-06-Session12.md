...
<a href="#aug7" style="color:#2F6690; text-decoration: none; text-align: center;"> 8/7/19 </a>
...
First, I took my socket ball extrusion off the Prusa to attach it. The print turned out slightly messy, so I used diagonal cutters to clean it up. When I tried to fit the wooden ball I found yesterday into the socket, it was unable to move around freely even with the extra clearance I added. Luckily, I found another metal ball in the blue cabinets that was slightly smaller. I had to use the heat gun to fit the socket arms around the ball, but now it can move around freely without coming out.

After fixing the socket wheel, I attached it to the chassis. It was slightly hard drilling the holes to be aligned, but eventually it all fit well. Then it was time to move onto code!
...
~ ~ ~ add (what would you have fixed given more time? what would you do? etc.)